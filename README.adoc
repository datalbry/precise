 ...
 * `+record+` describes a record, or a row in SQL. It primarily differs from `+document+` as it may not contain any binary data.
...
Precise ships with a few predefined types:
